...
function Footer({pokemon}) {
    ...
    return (
        <div className="fouter-container">
            <ul>
            <h3>The Pokemon Compagny</h3>
                <li>What's new</li>
                <li>Pokemon Parents Guide</li>
                <li>Customer Service</li>
                <li>About Our Company</li>
                <li>Pokemon Careers</li>
                <li>Select a Counry/Region</li>
                <li>Pokemon Press Site</li>
            </ul>
            <div className="icons br bl">               
                <svg 
            ...
            <div className='br'>
                <img />
                <ul className='footer-summary'>
                    <li className='underline'>Term of Use</li>
                    <li className='underline'>Privacy Notice</li>
                    <li className='underline'>Cookie Page</li>
                    <li className='underline'>Legal Info</li>
                    <li className='underline'>Security</li>
                </ul>

                <p>© 2021 Pokemon. TM, Nintendo.</p>
